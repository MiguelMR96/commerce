...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Category',
            fields=[
                ('name', models.CharField(default='Default category', max_length=64, primary_key=True, serialize=False)),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
            fields=[
                ...
                ('price', models.ForeignKey(default=0, on_delete=django.db.models.deletion.CASCADE, related_name='price', to='auctions.bid')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
